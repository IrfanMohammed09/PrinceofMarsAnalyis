...
setwd('/Users/irfanmohammed/Documents/sem 2/Bigdata/Project3')
getwd()
PoMarsAll=VCorpus(DirSource("/Users/irfanmohammed/Documents/sem 2/Bigdata/Project3/GroupProject/",ignore.case = TRUE,mode = "text"))
str(PoMarsAll)
PoMarsAll
...
PoMars=VCorpus(DirSource("/Users/irfanmohammed/Documents/sem 2/Bigdata/Project3/chapters",ignore.case = TRUE,mode = "text"))
str(PoMars)
PoMars
...
chapter_files <- list.files(path = "/Users/irfanmohammed/Documents/sem 2/Bigdata/Project3/chapters", pattern = "\\.txt$")
...
for (i in seq_along(chapter_files)) {
  chapter_text[i] <- get_text_as_string(file.path("/Users/irfanmohammed/Documents/sem 2/Bigdata/Project3/chapters", chapter_files[i]))
}
...
PoMarsAsString=get_text_as_string("/Users/irfanmohammed/Documents/sem 2/Bigdata/Project3/chapters/Chapter_1.txt")
PoMarsAsString
...
chapter_files <- list.files(path = "/Users/irfanmohammed/Documents/sem 2/Bigdata/Project3/chapters/", pattern = "Chapter_.*\\.txt$", full.names = TRUE)
